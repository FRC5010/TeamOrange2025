 ...
 * Generated on: 2025-11-10T23:43:12.512Z
 */
public final class SwerveConstants {
    // Drive base dimensions
    public static final double DRIVE_BASE_WIDTH_METERS = 0.546;
    public static final double DRIVE_BASE_LENGTH_METERS = 0.546;
    ...
    public static final double TOP_SPEED_METERS_PER_SEC = TOP_SPEED_MOTOR_RPM * WHEEL_DIAMETER_METERS * Math.PI / DRIVE_GEAR_RATIO / 60; // = 4.729 m/s
    ...
    REDUX_ENCODER, SRX_MAG_ENCODER, REV_ENCODER, THRIFTY_ABSOLUTE_ENCODER, THRIFTY_10PIN_ENCODER
    }
    ...
    public static final class ModuleConstants {
        ...
        public static final int FRONT_LEFT_AZIMUTH_MOTOR_ID = 2;
        public static final double FRONT_LEFT_ENCODER_OFFSET = 97.470703; // Encoder offset in degrees
        public static final boolean FRONT_LEFT_DRIVE_MOTOR_INVERTED = false;
        
        // Front Right Module
        public static final int FRONT_RIGHT_DRIVE_MOTOR_ID = 7;
        public static final int FRONT_RIGHT_AZIMUTH_MOTOR_ID = 8;
        public static final double FRONT_RIGHT_ENCODER_OFFSET = 175.253906; // Encoder offset in degrees
        public static final boolean FRONT_RIGHT_DRIVE_MOTOR_INVERTED = false;
        
        // Back Left Module
        public static final int BACK_LEFT_DRIVE_MOTOR_ID = 3;
        public static final int BACK_LEFT_AZIMUTH_MOTOR_ID = 4;
        public static final double BACK_LEFT_ENCODER_OFFSET = 304.189453; // Encoder offset in degrees
        public static final boolean BACK_LEFT_DRIVE_MOTOR_INVERTED = false;
        
        // Back Right Module
        public static final int BACK_RIGHT_DRIVE_MOTOR_ID = 5;
        public static final int BACK_RIGHT_AZIMUTH_MOTOR_ID = 6;
        public static final double BACK_RIGHT_ENCODER_OFFSET = 221.396484; // Encoder offset in degrees
        public static final boolean BACK_RIGHT_DRIVE_MOTOR_INVERTED = false;
        
        // Selected encoder type (from first module - assumes all modules use same encoder type)
        public static final EncoderType ENCODER_SELECTED = EncoderType.REDUX_ENCODER;
